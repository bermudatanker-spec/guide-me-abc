    ...
    "data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        // ✅ nieuw: success variant (stijl kun je later tweaken)
        success:
          "border border-emerald-300/70 bg-emerald-50 text-emerald-900 " +
          "dark:border-emerald-600/60 dark:bg-emerald-900 dark:text-emerald-50",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors " +
        "group-[.destructive]:border-muted/40 hover:bg-secondary group-[.destructive]:hover:border-destructive/30 " +
